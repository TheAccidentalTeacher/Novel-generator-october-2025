/**
 * Advanced human writing refinements captured from the legacy authoring engine.
 * These principles represent the level 5 authentic storytelling guidance used
 * during the "Copper Stars: The McCarthy Expeditions" analysis pass.
 */
export const advancedHumanWritingRefinements = {
  philosophy: {
    ...
    factionBreakingPoint: {
      ...
      implementation: {
        engineerSabotage: {
          ...
          prompt:
            'Create scenario where ally faction sabotages main character\'s plan from good intentions, creating no-villain conflict',
        },
        forceHardChoiceForLeader: {
          ...
          prompt:
            'Force leader into choice between authoritarian control and collaborative risk, with significant lasting consequences either way',
        },
      },
    },
    powerCosts: {
      ...
      implementation: {
        physicalMentalToll: {
          ...
          prompt:
            'After significant power use, show character suffering real biological/psychological costs that affect their capabilities',
        },
        empatheticFeedback: {
          ...
          prompt:
            'Create empathetic connection where character suffers when their area of protection/influence is harmed',
        },
      },
    },
    structuralSubversion: {
      ...
      implementation: {
        decentralizeDecisionMaking: {
          ...
          prompt:
            'Create scenario where story-altering decision must be made by isolated characters with no time for group consultation',
        },
        milkRunGoesWrong: {
          ...
          prompt:
            'Design seemingly simple mission that becomes catastrophic failure due to overlooked detail or character weakness',
        },
      },
    },
    proseRefinement: {
      ...
      implementation: {
        forbiddenPhraseExercise: {
          ...
          prompt:
            'Avoid all forbidden descriptors. Find new ways to convey character and equipment details through action, effect, and sensory impact',
        },
      },
    },
  },
...
export type AdvancedHumanWritingRefinements = typeof advancedHumanWritingRefinements;
