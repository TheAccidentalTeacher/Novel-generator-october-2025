import type { NovelGenerationJobData, NovelGenerationJobResult, NovelJobEngineMetadata, NovelJobSummary, SerializedDomainEvent, SerializedGenerationEvent } from '@letswriteabook/shared-types';
...
export interface NovelJobMapper {
    ...
    applyFailure(job: NovelJobAggregate, reason: string, options?: {
        readonly occurredAt?: string;
        readonly stage?: string;
        readonly metadata?: Record<string, unknown>;
    }): NovelJobAggregate;
